...
// Type: Ark.DiceCardSelfAbility_Sora2
...
namespace Ark
{
    //[战斗开始]这一幕中所有友方命中目标时恢复1点混乱抗性
    public class DiceCardSelfAbility_Sora2 : DiceCardSelfAbilityBase
    {
        public static string Desc = "[战斗开始]这一幕中所有友方命中目标时恢复1点混乱抗性";
        ...
        {
            public override void OnSuccessAttack(BattleDiceBehavior behavior) => _owner.breakDetail.RecoverBreak(1);
