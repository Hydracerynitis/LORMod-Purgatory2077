...
// Type: Ark.DiceCardSelfAbility_DU13
...
namespace Ark
{
    //[使用时]消耗1层[守护]使本书页所有骰子威力+2
    public class DiceCardSelfAbility_DU13 : DiceCardSelfAbilityBase
    {
        public static string Desc = "[使用时]消耗1层[守护]使本书页所有骰子威力+2";
