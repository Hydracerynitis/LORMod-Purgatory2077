...
// Type: Ark.DiceCardSelfAbility_Ptilopsis3
...
namespace Ark
{
    //[使用时]所有友方消耗1层[充能]并恢复8点体力
    public class DiceCardSelfAbility_Ptilopsis3 : DiceCardSelfAbilityBase
    {
        public static string Desc = "[使用时]所有友方消耗1层[充能]并恢复8点体力";
