...
namespace Ark
{
    //[使用时] 自身烧伤大于15层时下一幕进入匿踪且本书页骰子将骰出最大值
    public class DiceCardSelfAbility_TLL7 :DiceCardSelfAbilityBase 
    {
        public static string Desc = "[使用时] 自身烧伤大于15层时下一幕进入匿踪且本书页骰子将骰出最大值";
